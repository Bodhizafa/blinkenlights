...
pub const struct_spi_ioc_transfer = extern struct {
    tx_buf: __u64,
    rx_buf: __u64,
    len: __u32,
    speed_hz: __u32,
...
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__inline__`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/stddef.h:5:9
pub const __aligned_u64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/types.h:43:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/types.h:44:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/types.h:45:9
pub const __AC = @compileError("unable to translate C expr: expected ')' instead got '##'"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/const.h:20:9
pub const _UL = @compileError("unable to translate macro: undefined identifier `UL`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/const.h:25:9
pub const _ULL = @compileError("unable to translate macro: undefined identifier `ULL`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/const.h:26:9
pub const __ALIGN_KERNEL = @compileError("unable to translate macro: undefined identifier `typeof`"); // /home/bodhizafa/Source/RaspiLinux/usr/include/linux/const.h:31:9
...
pub inline fn _AT(T: anytype, X: anytype) @TypeOf(T(X)) {
    return T(X);
}
...
pub inline fn __KERNEL_DIV_ROUND_UP(n: anytype, d: anytype) @TypeOf(((n + d) - @as(c_int, 1)) / d) {
    return ((n + d) - @as(c_int, 1)) / d;
}
pub const SPI_CPHA = _BITUL(@as(c_int, 0));
pub const SPI_CPOL = _BITUL(@as(c_int, 1));
pub const SPI_MODE_0 = @as(c_int, 0) | @as(c_int, 0);
pub const SPI_MODE_1 = @as(c_int, 0) | SPI_CPHA;
pub const SPI_MODE_2 = SPI_CPOL | @as(c_int, 0);
pub const SPI_MODE_3 = SPI_CPOL | SPI_CPHA;
pub const SPI_MODE_X_MASK = SPI_CPOL | SPI_CPHA;
pub const SPI_CS_HIGH = _BITUL(@as(c_int, 2));
pub const SPI_LSB_FIRST = _BITUL(@as(c_int, 3));
pub const SPI_3WIRE = _BITUL(@as(c_int, 4));
pub const SPI_LOOP = _BITUL(@as(c_int, 5));
pub const SPI_NO_CS = _BITUL(@as(c_int, 6));
pub const SPI_READY = _BITUL(@as(c_int, 7));
pub const SPI_TX_DUAL = _BITUL(@as(c_int, 8));
pub const SPI_TX_QUAD = _BITUL(@as(c_int, 9));
pub const SPI_RX_DUAL = _BITUL(@as(c_int, 10));
pub const SPI_RX_QUAD = _BITUL(@as(c_int, 11));
pub const SPI_CS_WORD = _BITUL(@as(c_int, 12));
pub const SPI_TX_OCTAL = _BITUL(@as(c_int, 13));
pub const SPI_RX_OCTAL = _BITUL(@as(c_int, 14));
pub const SPI_3WIRE_HIZ = _BITUL(@as(c_int, 15));
pub const SPI_MODE_USER_MASK = _BITUL(@as(c_int, 16)) - @as(c_int, 1);
pub const SPI_IOC_MAGIC = 'k';
pub inline fn SPI_MSGSIZE(N: anytype) @TypeOf(if ((N * @import("std").zig.c_translation.sizeof(struct_spi_ioc_transfer)) < (@as(c_int, 1) << _IOC_SIZEBITS)) N * @import("std").zig.c_translation.sizeof(struct_spi_ioc_transfer) else @as(c_int, 0)) {
    return if ((N * @import("std").zig.c_translation.sizeof(struct_spi_ioc_transfer)) < (@as(c_int, 1) << _IOC_SIZEBITS)) N * @import("std").zig.c_translation.sizeof(struct_spi_ioc_transfer) else @as(c_int, 0);
}
// Broken
// pub inline fn SPI_IOC_MESSAGE(N: anytype) @TypeOf(_IOW(SPI_IOC_MAGIC, @as(c_int, 0), [SPI_MSGSIZE(N)]u8)) {
//    return _IOW(SPI_IOC_MAGIC, @as(c_int, 0), [SPI_MSGSIZE(N)]u8);
// }
pub const SPI_IOC_RD_MODE = _IOR(SPI_IOC_MAGIC, @as(c_int, 1), __u8);
pub const SPI_IOC_WR_MODE = _IOW(SPI_IOC_MAGIC, @as(c_int, 1), __u8);
pub const SPI_IOC_RD_LSB_FIRST = _IOR(SPI_IOC_MAGIC, @as(c_int, 2), __u8);
pub const SPI_IOC_WR_LSB_FIRST = _IOW(SPI_IOC_MAGIC, @as(c_int, 2), __u8);
pub const SPI_IOC_RD_BITS_PER_WORD = _IOR(SPI_IOC_MAGIC, @as(c_int, 3), __u8);
pub const SPI_IOC_WR_BITS_PER_WORD = _IOW(SPI_IOC_MAGIC, @as(c_int, 3), __u8);
pub const SPI_IOC_RD_MAX_SPEED_HZ = _IOR(SPI_IOC_MAGIC, @as(c_int, 4), __u32);
pub const SPI_IOC_WR_MAX_SPEED_HZ = _IOW(SPI_IOC_MAGIC, @as(c_int, 4), __u32);
pub const SPI_IOC_RD_MODE32 = _IOR(SPI_IOC_MAGIC, @as(c_int, 5), __u32);
pub const SPI_IOC_WR_MODE32 = _IOW(SPI_IOC_MAGIC, @as(c_int, 5), __u32);
pub const spi_ioc_transfer = struct_spi_ioc_transfer;
